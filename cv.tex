...
%\vspace*{-5pt}
	\item Matthew Halpern, Yuhao Zhu, Vijay Janapa Reddi\\
          {\color{blue}{Mobile CPU's Rise to Power: Quantifying the Impact of Generational Mobile CPU Design Trends on Performance, Energy, and User Satisfaction}}\\
          \textit{HPCA 2016 (to appear)}
...
\vspace*{-7pt}
{\large Thesis Research: \textit{High-Performance and Energy-Efficient Web Computing}} \hfill\textit{8/2011-present}\\
