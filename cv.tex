...
I am broadly interested in machine learning, computer vision, and computer
systems.

Currently, I am working on a project that explores the opportunities of a higher
performance system for object detection by dynamic domain-specific approximation.
...
\vspace*{-7pt}
{\large\textit{Flying IoT} (with Prof. Vijay Janapa Reddi)} \hfill\textit{8/2016-present}\\
\vspace*{-7pt}
...
\medskip
{\large\textit{Domain Specific Approximation for Object Detection in Flying Agents} (with Prof. Vijay Janapa Reddi)} \hfill\textit{8/2016-present}\\
\vspace*{-7pt}
\begin{itemize}[leftmargin=*] \itemsep -3pt
\vspace*{-5pt}
...
\begin{itemize}[leftmargin=*] \itemsep -3pt
\vspace*{-5pt}
  \item Built up Face Swap, an open source project, and wrap up a docker
  container for it.
